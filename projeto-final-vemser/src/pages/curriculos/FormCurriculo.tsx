...
function FormCurriculo() {
  ...
  const SingupSchema = Yup.object().shape({
    ...
    dataNascimento: Yup.string().required("Obrigatorio"),
    logradouro: Yup.string().required("Obrigatorio"),
    cidade: Yup.string().required("Obrigatorio"),
    bairro: Yup.string().required("Obrigatorio"),
    telefone: Yup.string().required("Obrigatorio"),
    numero: Yup.string().required("Obrigatorio"),
    senioridade: Yup.string().required("Obrigatorio"),
    instituicao: Yup.string().required("Obrigatorio"),
    descricaoDoCurso: Yup.string().required("Obrigatorio"),
    dataInicioCurso: Yup.string().required("Obrigatorio"),
    dataFimCurso: Yup.string().required("Obrigatorio"),
    nomeEmpresa: Yup.string().required("Obrigatorio"),
    cargo: Yup.string().required("Obrigatorio"),
    descricaoDoCargo: Yup.string().required("Obrigatorio"),
    dataInicioExperiencia: Yup.string().required("Obrigatorio"),
  });
            ...
            idCandidato
              ? {
                  ...
                  dataInicioExperiencia:
                    candidatoForUpdate.dataInicioExperiencia,
                  trabalhandoAtualmente:
                    candidatoForUpdate.trabalhandoAtualmente,
            ...
            <Form>
              <C.ContainerForm>
                ...
                <C.ContainerInputs>
                  ...
                  <C.DivFlexColumn>
                    <C.Label htmlFor="descricaoDoCurso">
                      descricaoDoCurso
                    </C.Label>
                    <Field
                      id="descricaoDoCurso"
                ...
                <C.ContainerInputs>
                  ...
                  <C.DivFlexColumn>
                    <C.Label htmlFor="nomeEmpresa">nomeEmpresa</C.Label>
                    <Field
                      id="nomeEmpresa"
                      name="nomeEmpresa"
                  ...
                  <C.DivFlexColumn>
                    <C.Label htmlFor="descricaoDoCargo">
                      descricaoDoCargo
                    </C.Label>
                    <Field
                      id="descricaoDoCargo"
                  ...
                  <C.DivFlexColumn>
                    <C.Label htmlFor="dataFimExperiencia">
                      dataFimExperiencia
                    </C.Label>
                    <Field
